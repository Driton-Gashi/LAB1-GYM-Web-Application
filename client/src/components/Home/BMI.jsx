...
export default function BMI(){
  ...
  return(
    <div className='bmi'>
      ...
      <h1>Lets Calculate Your <span style={{color:'var(--blue)'}}>BMI</span></h1>
      <p>Easily determine your body mass index with our accurate calculation tool.</p>
      <form action="" className='bmi-form'>
        <input type="number" placeholder='Weight/kg' className='inputF' onChange={getW}/>
        <input type="number" placeholder='Height/cm' className='inputF' onChange={getH}/>
      </form>
      <div className='bmi-result'>
        <p>Your BMI is: <span style={{color:'var(--blue)'}}>{bmi}</span> </p>
        <p>Your weight is: <span style={{color:'var(--blue)'}}>{bmiDesc}</span> </p>
      </div>
